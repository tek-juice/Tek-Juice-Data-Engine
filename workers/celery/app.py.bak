...
celery_app.conf.update(
    ...
    beat_schedule={
        "scrape-trends-hourly": {
            ...
            # No sources kwarg — lets TrendScraperScheduler._free_sources() decide.
            # That method adds google/bing only when their API keys are configured,
            # so the beat schedule never burns free-tier quotas unintentionally.
            # To force specific sources: pass kwargs={"sources": ["news", "indirect"]}
        },
