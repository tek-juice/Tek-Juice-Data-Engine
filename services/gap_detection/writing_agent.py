        ...
        for draft in result.drafts:
            await session.execute(
                text("""
                    INSERT INTO gap_content_drafts
                        (document_id, tenant_id, topic, intent, priority,
                         ...
                         geo_score, aeo_score, composite_score, quality_score,
                         beats_paid_ads, projected_position)
                    VALUES
                        (:document_id, :tenant_id, :topic, :intent, :priority,
                         :draft_text, :word_count, :query_variants, :schema_types,
                         :authority_signals, :content_brief,
                    ...
                    DO UPDATE SET
                        ...
                        beats_paid_ads     = EXCLUDED.beats_paid_ads,
                ...
                """),
                {
                    ...
                    "beats_paid_ads":    draft.beats_paid_ads,
                    "projected_position": draft.projected_position,
                },
            )
            inserted += 1
